...
//  const { name } = route.params;
  ...
  const cancelOrder = async (tourId) => {
    const url = `${backendURL}api/orders/${tourId}`;
  ...
  const viewProfile = (tour) => {
    navigation.navigate("ViewHotel", { tour });
  };
                ...
                <View className="flex-1 flex justify-center pl-3 space-y-3">
                  ...
                  <View className="flex-row space-x-3">
                    <View className="flex-row space-x-1">
                      ...
                      <Text className="text-xs text-gray-700">{tour.price}</Text>
                  ...
                  <View className="flex-row space-x-1">
                      ...
                      <Text className="text-xs text-gray-700">{tour.description}</Text>
