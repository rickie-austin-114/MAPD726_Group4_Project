...
const ListAttractionsScreen = ({ route, navigation }) => {
  ...
  const fetchTours = async () => {
    try {
      if (activeCategory === "All") {
        ...
        const url = `${backendURL}api/attractions/${name}`;
        console.log(url);
  ...
  const viewProfile = (tour) => {
    navigation.navigate("ViewAttraction", { tour });
  };
...
export default ListAttractionsScreen;
